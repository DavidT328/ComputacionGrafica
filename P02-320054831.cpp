...
static const char* fShaderColorRed = "shaders/shadercolorRed.frag";
static const char* vShaderColorBlue = "shaders/shadercolorBlue.vert";
static const char* fShaderColorBlue = "shaders/shadercolorBlue.frag";
static const char* vShaderColorBrown = "shaders/shadercolorBrown.vert";
static const char* fShaderColorBrown = "shaders/shadercolorBrown.frag";
static const char* vShaderColorGreenO = "shaders/shadercolorGreenO.vert";
static const char* fShaderColorGreenO = "shaders/shadercolorGreenO.frag";
static const char* vShaderColorGreen = "shaders/shadercolorGreen.vert";
static const char* fShaderColorGreen = "shaders/shadercolorGreen.frag";
...
void CreateShaders()
{
	...
	shaderBrown->CreateFromFiles(vShaderColorBrown, fShader);
	shaderList.push_back(*shaderBrown);

	//Shader color verde oscuro
	Shader *shaderGreenO = new Shader();
	shaderGreenO->CreateFromFiles(vShaderColorGreenO, fShader);
	shaderList.push_back(*shaderGreenO);

	//Shader color verde 
	Shader *shaderGreen = new Shader();
	shaderGreen->CreateFromFiles(vShaderColorGreen, fShader);
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		model = glm::scale(model, glm::vec3(0.8f, 1.0f, 0.30f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		...
		model = glm::scale(model, glm::vec3(0.25f, 0.3f, 0.30f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[1]->RenderMesh();
		...
		model = glm::scale(model, glm::vec3(0.35f, 0.4f, 0.30f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[0]->RenderMesh();
		...
		model = glm::scale(model, glm::vec3(0.2f, 0.4f, 0.30f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[1]->RenderMesh();

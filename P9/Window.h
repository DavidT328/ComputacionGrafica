...
public:
	...
	GLfloat getlmp1() { return lmp1; }
	GLfloat getlmp2() { return lmp2; }
	GLfloat getAnimacion() { return animacion; }
	GLfloat getDado() { return shouldRollOctahedron; }
...
private: 
	...
	GLfloat posX, posY, posZ, lmp1,luces, lmp2, animacion;
	bool keys[1024];
	bool shouldRollOctahedron;

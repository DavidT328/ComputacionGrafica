...
void CrearPiramideCuadrangular()
{
	...
	piramide->CreateMeshGeometry(piramidecuadrangular_vertices, piramidecuadrangular_indices, 18, 21);
...
/*
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.255f, 0.255f, 0.255f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.155f, 0.155f, 0.155f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render();
		//Parte superior 
		model = modelaux;
		...
		//Orejas
		model = modelaux3;
		model = glm::translate(model, glm::vec3(0.0f, 1.75f, 0.75f));
		...
		//Ojos
		model = modelaux3;
		model = glm::translate(model, glm::vec3(-1.15f, 0.25f, 0.5f));
